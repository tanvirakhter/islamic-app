...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: t("page.umrah.title"),
    description: t("page.umrah.description"),
  };
}
...
export default function UmrahPage() {
  ...
  const steps = raw["umrah.steps"];

  return (
    <>
      <PageHeader
        eyebrow={t("page.umrah.eyebrow")}
        title={t("page.umrah.title")}
        description={t("page.umrah.description")}
      />
        ...
        {steps.map((s, i) => (
          <Card key={s.title}>
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className={`text-lg font-semibold text-ink ${fontClass}`}>{s.title}</p>
